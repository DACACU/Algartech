...
namespace Algartech.Models
{
    public partial class DBAlgartechVentaContext : DbContext
    {
        public DBAlgartechVentaContext()
        {
        }

        public DBAlgartechVentaContext(DbContextOptions<DBAlgartechVentaContext> options)
            : base(options)
        {
        }
